	...
	<div id="inicio" class="estructura nologged">
		...
		<section id="cuerpo" class="cleaner">
			<div id="first" class="ad-slider cleaner">
				<ul class="bxslider">
					<li class="ad">						
						<div class="candado cleaner">
							<i class="myicon-candado"></i>
							<div class="user-candado">
								<i class="myicon-user-candado"></i>
							</div>
						</div>
						<div class="titulo cleaner">
							<h2>a great retail experience</h2>
							<h3>whit a unique plataform1</h3>							
						</div>
					</li>
					<li class="ad">
						<div class="candado cleaner">
						...
						<div class="titulo cleaner">
							<h2>a great retail experience</h2>
							<h3>whit a unique plataform2</h3>							
						</div>
					</li>
				</ul>
			...
			<div id="second" class="cleaner">
				...
				<div class="but cleaner">
					...
					<a href="lookbook.php" class="cleaner"><button class="but-type1" type="button">see all lookbooks</button></a>
				</div>
			</div>
			<div id="collection" class="cleaner">
				<div id="col-first" class="cleaner">
					<div class="cleaner"></div>
					<div class="cleaner">
						<div class="titulo cleaner">
							<h3>latest collection</h3>
							<h4>check out our new staff</h4>
						</div>					
					</div>
					<div class="cleaner"></div>
				</div>
