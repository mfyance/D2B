...
<head>
	...
	<![endif]-->	
	<title>Profile Designer - D2B</title>	
</head>
<body>
				...
				<div class="tabber" id="profilemenu">
					<div class="tabbertab">
						...
						<div id="myprofile" class="content cleaner">
							...
							<div id="mysettings" class="settings myform-style1 cleaner">
								<div class="cleaner load"><span class="loading"></span></div>
								<div class="cleaner" id="myset-content">
									<form id="frm-setting" action="" class="cleaner">										
										<div id="onlyinputs" class="put-padding cleaner">
											...
											<div class="myrow multiselect cleaner myselect">
												<label for="tags4search">Tags for search:</label>
												<ul name="tags4search" id="tags4search" class="tags4search"></ul>
											</div>
										</div>
										<!-- privacy -->
										<div class="cleaner put-padding" id="privacy">
										...
										<div class="myrow but cleaner">
											<button class="butupdate" type="submit"><i class="myicon-update animated"></i>register my account</button>
											<div class="success cleaner animated bounceIn" style="visibility: visible;"><p>this section has been updated successfully. <i class="myicon-done "></i></p></div>
										</div>										
									</form>
								</div>
							</div>
					...
					<div class="tabbertab">
						...
						<div class="content cleaner">
							<div class="helper cleaner">
								<p><i class="myicon-helper"></i>in this section you can edit your data already entered and complete your registration <i class="myicon-show-video"></i><a href="#">Tutorial</a></p>
							</div>
							<div id="myorders" class="cleaner">
								<div class="title cleaner">
									<div class="cleaner">
										Order description <i class="myicon-reg-arrow"></i>
									</div>
									<div class="cleaner">User description</div>
									<div class="cleaner">Order stage</div>
								</div>
								<div class="info cleaner">
									<div class="order-des cleaner">
										...
										<div class="myorders  cleaner">
											<dl>
												<dt class="row cleaner">
													<p><span>1. </span>River Island Crew Neck Jumper /SSsumer colecction (look 01)</p>
													<i class="my-arrow-1"></i>
												</dt>
												<dd>
													<div class="cleaner">Amount: 3</div>
													<div class="cleaner">Colors: (beige) (white)(black)</div>
													<div class="cleaner">Size: Uk 8/ EU 36</div>
													<div class="cleaner">Price : $ 60.00</div>
													<div class="cleaner">Size: Uk 8/ EU 36</div>
													<div class="cleaner">Price : $ 60.00</div>
												</dd>
												<dt class="row cleaner">
													<p><span>2.</span> River Island Crew Neck Jumper /SSsumer colecction (look 01)</p>
													<i class="my-arrow-1"></i>
												</dt>
												<dd>
													<div class="cleaner">Amount: 3</div>
									...
									<div class="user-des cleaner">
										<div class="row nopad cleaner">
											<i class="myicon-user2"></i>
											<div class="dates cleaner">
												<h3>wholesaler</h3>
												<em>name loren</em>
												<span>Fahion designer</span>
												<div class="ranking"></div>												
											</div>
											<div class="buts cleaner">
												<button type="button" class="but-type6"><i class="myicon-or-user"></i>view his profile</button>
												<button type="button" class="but-type6"><i class="myicon-or-rate"></i> this user</button>
											</div>
										</div>
									</div>
									<div class="order-stage cleaner">
										<div class="row nopad cleaner">
											<div class="cleaner">
												<select name="country" id="country" class="selectpicker">
												    <option>Ship</option>
											...
											<div class="delivery cleaner">
												<div class="cleaner"><i class="myicon-or-delivery"></i></div>
												<div class="cleaner">This order was delivered successfully</div>
											</div>
											<div class="but cleaner">
												<button type="button" class="butconfirm"><i class="myicon-or-check animated"></i>confirm</button>
											</div>
										</div>
									</div>
								</div>
							</div>
							<div id="messages" class="cleaner">
								<div id="show-messages" class="cleaner">
									<div  class="cleaner">
										<i class="myicon-or-message"></i><em>Loren ipsum User name</em><span>send you a  1 new message.</span>
									</div>
									<div class="cleaner"><i class="my-arrow-1"></i></div>
								</div>
								<div id="hide-box" class="cleaner animated">
									<!--  -->
									<div class="message-content cleaner">
										<div class="message cleaner">
											<div class="cleaner">
												<i class="myicon-or-avatar"></i>
											</div>
											<div class="cleaner">
												<div class="title cleaner">
													<div class="cleaner">Mesage tittle Loren ipsum.</div>
													<div class="cleaner">14 de diciembre de 2012   07:00 pm.</div>
												</div>
												<div class="info cleaner">
													<i class="myicon-helper"></i>
													<p>Hello, i want to buy all this products, and im offer you $200.00 for all the package  text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took.</p>
												</div>
											</div>
										</div>
										<div class="message cleaner">
											<div class="cleaner">
												<i class="myicon-or-avatar-me"></i>
											</div>
											<div class="cleaner">
												<div class="title cleaner">
													<div class="cleaner">Mesage tittle Loren ipsum.</div>
									...
									<div id="reply-message" class="message-content cleaner">
										<div class="message cleaner">
											<div class="cleaner">
												<i class="myicon-or-avatar-me"></i>
											</div>
											<div class="cleaner">
												<div class="cleaner" id="posting">
													<textarea class="new-reply" name="post" id="post"></textarea>
													<i class="myicon-reply-post"></i>
												</div>
												<div class="cleaner">
													<button type="button" class="but-reply">reply <i class="myicon-reply"></i></button>
												</div>
											</div>
										</div>
									</div>
	...
	<!--  Ranking  -->
	<script src="privado/js/jquery.raty.min.js"></script>
	<!-- Validate Inputs -->
